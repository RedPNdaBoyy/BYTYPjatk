...
public class Bank
     ...
     * @throws AccountDoesNotExistException If the account does not exist
		...
		if jest tak staworzony że jeśli konto istnieje to wywołuje Exception że dane konto nie istnieje
	...
	/**
	 * Sprawdzanie czy dany klient istnieje
	 * @param accountid sprawdzana wartość id
	 *
     * */
